...
'.$message.'
    ...
    // public function get_user($name = 'default'){
    //     $user = array(
    //         'default' => array(
    //             'smtp_user' => 'manage.hoteljob@gmail.com',
    //             'smtp_pass'=> 'toommaroot'
    //         ),
    //     );
    //     return isset($user[$name])?$user[$name]:$user['default'];
    // }

    // public function change_user($name = 'default'){
    //     $config = $this->get_user($name);
    //     $this->initialize($config);
    // }
