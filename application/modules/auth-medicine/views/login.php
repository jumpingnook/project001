            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="text-center">
                    <h6 class="h3 text-gray-900 font-weight-bold mb-4">เข้าสู่ระบบ M</h6>
                  </div>
                  <form class="user" action="<?php echo base_url(url_index().'auth-medicine/auth/login');?>" method="post">
