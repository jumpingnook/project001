...
<div id="document" class="row mb-2" style="border: 1px solid #ccc;">
  <div class="col-lg-12 document" >
    ...
    <?php if(isset($data['leave_type_id']) && intval($data['leave_type_id'])==1){$doc[0] = 'document/leave/1.1.png';?>
      ...
      <span style="top: 60.2%;left: 21%;"><?php echo isset($data['signature_hr_date']) && trim($data['signature_hr_date'])!=''?date('d/m/',strtotime($data['signature_hr_date'])).(date("Y",strtotime($data['signature_hr_date']))+543):''; ?></span>

      <span style="top: 52%;left: 51%;"><?php echo isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==1?'&#10003;':''; ?></span>
      <span style="top: 52%;left: 64.4%;"><?php echo isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==2?'&#10003;':''; ?></span>
      <span style="top: 55%;left: 58%;"><img src="<?php echo isset($data['personnel_id_2']) && intval($data['personnel_id_2'])!=0 && $data['signature_date_personnel_2']!='' && isset($personnel_list['data'][$data['personnel_id_2']])?$personnel_list['data'][$data['personnel_id_2']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      ...
      <span class="overflow-text" style="top: 60%;left: 58%;width: 30%;height: 2.5%;"><?php echo isset($data['position_personnel_2']) && trim($data['position_personnel_2'])!=''?$data['position_personnel_2']:''; ?></span>
      <span style="top: 62.2%;left: 58%;"><?php echo isset($data['signature_date_personnel_2']) && trim($data['signature_date_personnel_2'])!=''?date('d/m/',strtotime($data['signature_date_personnel_2'])).(date("Y",strtotime($data['signature_date_personnel_2']))+543):''; ?></span>



      <span style="top: 67%;left: 14.5%;"><?php echo isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==1?'&#10003;':''; ?></span>
      <span style="top: 67%;left: 28%;"><?php echo isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==2?'&#10003;':''; ?></span>
      <span style="top: 70%;left: 21%;"><img src="<?php echo isset($data['personnel_id_3']) && intval($data['personnel_id_3'])!=0 && $data['signature_date_personnel_3']!='' && isset($personnel_list['data'][$data['personnel_id_3']])?$personnel_list['data'][$data['personnel_id_3']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 73%;left: 21%;">
        <?php 
      ...
      <span class="overflow-text" style="top: 75.2%;left: 21%;width: 28%;height: 2.5%;"><?php echo isset($data['position_personnel_3']) && trim($data['position_personnel_3'])!=''?$data['position_personnel_3']:''; ?></span>
      <span style="top: 77.4%;left: 21%;"><?php echo isset($data['signature_date_personnel_3']) && trim($data['signature_date_personnel_3'])!=''?date('d/m/',strtotime($data['signature_date_personnel_3'])).(date("Y",strtotime($data['signature_date_personnel_3']))+543):''; ?></span>



      <span style="top: 67%;left: 51.2%;"><?php echo isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==1?'&#10003;':''; ?></span>
      <span style="top: 67%;left: 64.8%;"><?php echo isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==2?'&#10003;':''; ?></span>
      <span style="top: 70.2%;left: 58%;"><img src="<?php echo isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && $data['signature_date_personnel_4']!='' && isset($personnel_list['data'][$data['personnel_id_4']])?$personnel_list['data'][$data['personnel_id_4']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 73%;left: 58%;">
        <?php 
          if(isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && isset($personnel_list['data'][$data['personnel_id_4']])){
            echo $personnel_list['data'][$data['personnel_id_4']]['title']; 
            echo $personnel_list['data'][$data['personnel_id_4']]['name_th'].'&nbsp;'; 
            echo $personnel_list['data'][$data['personnel_id_4']]['surname_th'];
          }
        ?>
      </span>
      <span class="overflow-text" style="top: 75.2%;left: 58%;width: 30%;height: 2.5%;"><?php echo isset($data['position_personnel_4']) && trim($data['position_personnel_4'])!=''?$data['position_personnel_4']:''; ?></span>
      <span style="top: 77.4%;left: 58%;"><?php echo isset($data['signature_date_personnel_4']) && trim($data['signature_date_personnel_4'])!=''?date('d/m/',strtotime($data['signature_date_personnel_4'])).(date("Y",strtotime($data['signature_date_personnel_4']))+543):''; ?></span>
          
      <span style="top: 82%;left: 51.6%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==1?'&#10003;':''; ?></span>
      <span style="top: 82%;left: 60.6%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==2?'&#10003;':''; ?></span>
      <span style="top: 82%;left: 70.6%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==3?'&#10003;':''; ?></span>
      <span style="top: 87.4%;left: 58%;"><img src="<?php echo isset($data['personnel_id_5']) && intval($data['personnel_id_5'])!=0 && $data['signature_date_personnel_5']!='' && isset($personnel_list['data'][$data['personnel_id_5']])?$personnel_list['data'][$data['personnel_id_5']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 90.3%;left: 58%;">
        <?php 
      ...
      <span class="overflow-text" style="top: 92.6%;left: 58%;width: 30%;height: 2.5%;"><?php echo isset($data['position_personnel_5']) && trim($data['position_personnel_5'])!=''?$data['position_personnel_5']:''; ?></span>
      <span style="top: 94.8%;left: 58%;"><?php echo isset($data['signature_date_personnel_5']) && trim($data['signature_date_personnel_5'])!=''?date('d/m/',strtotime($data['signature_date_personnel_5'])).(date("Y",strtotime($data['signature_date_personnel_5']))+543):''; ?></span>



    <?php }elseif(isset($data['leave_type_id']) && intval($data['leave_type_id'])>=2 && intval($data['leave_type_id'])<=3){ ?>
      ...
      <span style="top: 48.6%;left: 37%;"><?php echo isset($data['leave_type_id']) && $data['leave_type_id']==2?floatval($data['period_count']):floatval($old_leave_type[2]);?></span>
      ...
      <span style="top: 60%;left: 21%;">
        <?php 
          // if(isset($data['hr_personnel_id']) && intval($data['hr_personnel_id'])!=0 && isset($personnel_list['data'][$data['personnel_id_1']])){
          //   echo $personnel_list['data'][$data['hr_personnel_id']]['title']; 
          //   echo $personnel_list['data'][$data['hr_personnel_id']]['name_th'].'&nbsp;'; 
          //   echo $personnel_list['data'][$data['hr_personnel_id']]['surname_th'];
          // }
      ...
      <span style="top: 65.8%;left: 15%;"><?php echo isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==1?'&#10003;':''; ?></span>
      <span style="top: 65.8%;left: 28.8%;"><?php echo isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==2?'&#10003;':''; ?></span>
      <span style="top: 68.8%;left: 21%;"><img src="<?php echo isset($data['personnel_id_2']) && intval($data['personnel_id_2'])!=0 && $data['signature_date_personnel_2']!='' && isset($personnel_list['data'][$data['personnel_id_2']])?$personnel_list['data'][$data['personnel_id_2']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 71.8%;left: 21%;">
        <?php 
          if(isset($data['personnel_id_2']) && intval($data['personnel_id_2'])!=0 && isset($personnel_list['data'][$data['personnel_id_2']])){
            echo $personnel_list['data'][$data['personnel_id_2']]['title']; 
            echo $personnel_list['data'][$data['personnel_id_2']]['name_th'].'&nbsp;'; 
      ...
      <span style="top: 74%;left: 21%;"><?php echo isset($data['position_personnel_2']) && trim($data['position_personnel_2'])!=''?$data['position_personnel_2']:''; ?></span>
      <span style="top: 76.2%;left: 21%;"><?php echo isset($data['signature_date_personnel_2']) && trim($data['signature_date_personnel_2'])!=''?date('d/m/',strtotime($data['signature_date_personnel_2'])).(date("Y",strtotime($data['signature_date_personnel_2']))+543):''; ?></span>


      <span style="top: 65.8%;left: 54.2%;"><?php echo isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==1?'&#10003;':''; ?></span>
      <span style="top: 65.8%;left: 67.8%;"><?php echo isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==2?'&#10003;':''; ?></span>
      <span style="top: 68.8%;left: 60%;"><img src="<?php echo isset($data['personnel_id_3']) && intval($data['personnel_id_3'])!=0 && $data['signature_date_personnel_3']!='' && isset($personnel_list['data'][$data['personnel_id_3']])?$personnel_list['data'][$data['personnel_id_3']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 71.8%;left: 60%;">
        <?php 
          if(isset($data['personnel_id_3']) && intval($data['personnel_id_3'])!=0 && isset($personnel_list['data'][$data['personnel_id_3']])){
            echo $personnel_list['data'][$data['personnel_id_3']]['title']; 
            echo $personnel_list['data'][$data['personnel_id_3']]['name_th'].'&nbsp;'; 
      ...
      <span style="top: 74%;left: 60%;"><?php echo isset($data['position_personnel_3']) && trim($data['position_personnel_3'])!=''?$data['position_personnel_3']:''; ?></span>
      <span style="top: 76.2%;left: 60%;"><?php echo isset($data['signature_date_personnel_3']) && trim($data['signature_date_personnel_3'])!=''?date('d/m/',strtotime($data['signature_date_personnel_3'])).(date("Y",strtotime($data['signature_date_personnel_3']))+543):''; ?></span>


      <span style="top: 81%;left: 15%;"><?php echo isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==1?'&#10003;':''; ?></span>
      <span style="top: 81%;left: 32%;"><?php echo isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==2?'&#10003;':''; ?></span>
      <span style="top: 84%;left: 21%;"><img src="<?php echo isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && $data['signature_date_personnel_4']!='' && isset($personnel_list['data'][$data['personnel_id_4']])?$personnel_list['data'][$data['personnel_id_4']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 86.8%;left: 21%;">
        <?php 
          if(isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && isset($personnel_list['data'][$data['personnel_id_4']])){
            echo $personnel_list['data'][$data['personnel_id_4']]['title']; 
            echo $personnel_list['data'][$data['personnel_id_4']]['name_th'].'&nbsp;'; 
      ...
      <span style="top: 89.2%;left: 21%;"><?php echo isset($data['position_personnel_4']) && trim($data['position_personnel_4'])!=''?$data['position_personnel_4']:''; ?></span>
      <span style="top: 91.4%;left: 21%;"><?php echo isset($data['signature_date_personnel_4']) && trim($data['signature_date_personnel_4'])!=''?date('d/m/',strtotime($data['signature_date_personnel_4'])).(date("Y",strtotime($data['signature_date_personnel_4']))+543):''; ?></span>


      <span style="top: 81%;left: 55.4%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==1?'&#10003;':''; ?></span>
      <span style="top: 81%;left: 64%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==2?'&#10003;':''; ?></span>
      <span style="top: 81%;left: 74.2%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==3?'&#10003;':''; ?></span>
      <span style="top: 86.4%;left: 60%;"><img src="<?php echo isset($data['personnel_id_5']) && intval($data['personnel_id_5'])!=0 && $data['signature_date_personnel_5']!='' && isset($personnel_list['data'][$data['personnel_id_5']])?$personnel_list['data'][$data['personnel_id_5']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      ...
      <span style="top: 91.4%;left: 61%;"><?php echo isset($data['position_personnel_5']) && trim($data['position_personnel_5'])!=''?$data['position_personnel_5']:''; ?></span>
      <span style="top: 93.6%;left: 61%;"><?php echo isset($data['signature_date_personnel_5']) && trim($data['signature_date_personnel_5'])!=''?date('d/m/',strtotime($data['signature_date_personnel_5'])).(date("Y",strtotime($data['signature_date_personnel_5']))+543):''; ?></span>
    ...
    <?php }elseif(isset($data['leave_type_id']) && intval($data['leave_type_id'])==4){ $doc[0] = 'document/leave/4.1.1.png';$doc[1] = 'document/leave/4.1.2.png';?>
      ...
      <span style="top: 52.8%;left: 22%;"><?php echo isset($data['signature_hr_date']) && trim($data['signature_hr_date'])!=''?date('d/m/',strtotime($data['signature_hr_date'])).(date("Y",strtotime($data['signature_hr_date']))+543):''; ?></span>


      <span style="top: 56.8%;left: 15%;"><?php echo isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==1?'&#10003;':''; ?></span>
      <span style="top: 56.8%;left: 26.6%;"><?php echo isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==2?'&#10003;':''; ?></span>
      ...
      <span style="top: 64%;left: 21%;"><?php echo isset($data['position_personnel_2']) && trim($data['position_personnel_2'])!=''?$data['position_personnel_2']:''; ?></span>
      <span style="top: 65.8%;left: 21%;"><?php echo isset($data['signature_date_personnel_2']) && trim($data['signature_date_personnel_2'])!=''?date('d/m/',strtotime($data['signature_date_personnel_2'])).(date("Y",strtotime($data['signature_date_personnel_2']))+543):''; ?></span>


      <span style="top: 56.8%;left: 56.8%;"><?php echo isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==1?'&#10003;':''; ?></span>
      <span style="top: 56.8%;left: 68.2%;"><?php echo isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==2?'&#10003;':''; ?></span>
      ...
      <span style="top: 64%;left: 62%;"><?php echo isset($data['position_personnel_3']) && trim($data['position_personnel_3'])!=''?$data['position_personnel_3']:''; ?></span>
      <span style="top: 65.8%;left: 62%;"><?php echo isset($data['signature_date_personnel_3']) && trim($data['signature_date_personnel_3'])!=''?date('d/m/',strtotime($data['signature_date_personnel_3'])).(date("Y",strtotime($data['signature_date_personnel_3']))+543):''; ?></span>


      <span style="top: 70.4%;left: 15%;"><?php echo isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==1?'&#10003;':''; ?></span>
      <span style="top: 70.4%;left: 32%;"><?php echo isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==2?'&#10003;':''; ?></span>
      <span style="top: 73.4%;left: 21%;"><img src="<?php echo isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && $data['signature_date_personnel_4']!='' && isset($personnel_list['data'][$data['personnel_id_4']])?$personnel_list['data'][$data['personnel_id_4']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 75.8%;left: 21%;">
        <?php 
          if(isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && isset($personnel_list['data'][$data['personnel_id_4']])){
            echo $personnel_list['data'][$data['personnel_id_4']]['title']; 
            echo $personnel_list['data'][$data['personnel_id_4']]['name_th'].'&nbsp;'; 
      ...
      <span style="top: 77.6%;left: 21%;"><?php echo isset($data['position_personnel_4']) && trim($data['position_personnel_4'])!=''?$data['position_personnel_4']:''; ?></span>
      <span style="top: 79.4%;left: 21%;"><?php echo isset($data['signature_date_personnel_4']) && trim($data['signature_date_personnel_4'])!=''?date('d/m/',strtotime($data['signature_date_personnel_4'])).(date("Y",strtotime($data['signature_date_personnel_4']))+543):''; ?></span>


      <span style="top: 70.4%;left: 57.8%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==1?'&#10003;':''; ?></span>
      <span style="top: 70.4%;left: 69.2%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==2?'&#10003;':''; ?></span>
      ...
      <span style="top: 77.6%;left: 64%;"><?php echo isset($data['position_personnel_5']) && trim($data['position_personnel_5'])!=''?$data['position_personnel_5']:''; ?></span>
      <span style="top: 79.4%;left: 64%;"><?php echo isset($data['signature_date_personnel_5']) && trim($data['signature_date_personnel_5'])!=''?date('d/m/',strtotime($data['signature_date_personnel_5'])).(date("Y",strtotime($data['signature_date_personnel_5']))+543):''; ?></span>



      <span style="top: 83.6%;left: 58.4%;"><?php echo isset($data['approve_personnel_6']) && intval($data['approve_personnel_6'])==1?'&#10003;':''; ?></span>
      <span style="top: 83.6%;left: 66.4%;"><?php echo isset($data['approve_personnel_6']) && intval($data['approve_personnel_6'])==2?'&#10003;':''; ?></span>
      <span style="top: 83.6%;left: 75.8%;"><?php echo isset($data['approve_personnel_6']) && intval($data['approve_personnel_6'])==3?'&#10003;':''; ?></span>
      ...
      <span style="top: 93.4%;left: 64%;"><?php echo isset($data['position_personnel_6']) && trim($data['position_personnel_6'])!=''?$data['position_personnel_6']:''; ?></span>
      <span style="top: 95.4%;left: 64%;"><?php echo isset($data['signature_date_personnel_6']) && trim($data['signature_date_personnel_6'])!=''?date('d/m/',strtotime($data['signature_date_personnel_6'])).(date("Y",strtotime($data['signature_date_personnel_6']))+543):''; ?></span>
    ...
    <?php }elseif(isset($data['leave_type_id']) && intval($data['leave_type_id'])==5){ $doc[0] = 'document/leave/5.1.png';?>
      ...
      <span style="top: 26%;left: 79.5%;"><?php echo isset($data['period_count_all'])?floatval($data['period_count_all']):'0';?></span>
      ...
      <span style="top: 45.4%;left: 14.2%;"><?php echo isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==1?'&#10003;':''; ?></span>
      <span style="top: 45.4%;left: 27.8%;"><?php echo isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==2?'&#10003;':''; ?></span>
      ...
      <span style="top: 53.4%;left: 19.5%;"><?php echo isset($data['position_personnel_2']) && trim($data['position_personnel_2'])!=''?$data['position_personnel_2']:''; ?></span>
      <span style="top: 55.6%;left: 19.5%;"><?php echo isset($data['signature_date_personnel_2']) && trim($data['signature_date_personnel_2'])!=''?date('d/m/',strtotime($data['signature_date_personnel_2'])).(date("Y",strtotime($data['signature_date_personnel_2']))+543):''; ?></span>



      <span style="top: 45.2%;left: 54%;"><?php echo isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==1?'&#10003;':''; ?></span>
      <span style="top: 45.2%;left: 67.4%;"><?php echo isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==2?'&#10003;':''; ?></span>
      ...
      <span style="top: 53.2%;left: 60.5%;"><?php echo isset($data['position_personnel_3']) && trim($data['position_personnel_3'])!=''?$data['position_personnel_3']:''; ?></span>
      <span style="top: 55.4%;left: 60.5%;"><?php echo isset($data['signature_date_personnel_3']) && trim($data['signature_date_personnel_3'])!=''?date('d/m/',strtotime($data['signature_date_personnel_3'])).(date("Y",strtotime($data['signature_date_personnel_3']))+543):''; ?></span>



      <span style="top: 61.8%;left: 14.8%;"><?php echo isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==1?'&#10003;':''; ?></span>
      <span style="top: 61.8%;left: 28.4%;"><?php echo isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==2?'&#10003;':''; ?></span>
      <span style="top: 65.2%;left: 22.5%;"><img src="<?php echo isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && $data['signature_date_personnel_4']!='' && isset($personnel_list['data'][$data['personnel_id_4']])?$personnel_list['data'][$data['personnel_id_4']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 67.8%;left: 21.5%;">
        <?php 
          if(isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && isset($personnel_list['data'][$data['personnel_id_4']])){
            echo $personnel_list['data'][$data['personnel_id_4']]['title']; 
            echo $personnel_list['data'][$data['personnel_id_4']]['name_th'].'&nbsp;'; 
      ...
      <span style="top: 70%;left: 21.5%;"><?php echo isset($data['position_personnel_4']) && trim($data['position_personnel_4'])!=''?$data['position_personnel_4']:''; ?></span>
      <span style="top: 72.2%;left: 21.5%;"><?php echo isset($data['signature_date_personnel_4']) && trim($data['signature_date_personnel_4'])!=''?date('d/m/',strtotime($data['signature_date_personnel_4'])).(date("Y",strtotime($data['signature_date_personnel_4']))+543):''; ?></span>



      <span style="top: 61.8%;left: 55.5%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==1?'&#10003;':''; ?></span>
      <span style="top: 61.8%;left: 66.5%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==2?'&#10003;':''; ?></span>
      <span style="top: 61.8%;left: 78.5%;"><?php echo isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==3?'&#10003;':''; ?></span>
      <span style="top: 65.2%;left: 62.5%;"><img src="<?php echo isset($data['personnel_id_5']) && intval($data['personnel_id_5'])!=0 && $data['signature_date_personnel_5']!='' && isset($personnel_list['data'][$data['personnel_id_5']])?$personnel_list['data'][$data['personnel_id_5']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
      <span style="top: 67.8%;left: 62.5%;">
        <?php 
          if(isset($data['personnel_id_5']) && intval($data['personnel_id_4'])!=0 && isset($personnel_list['data'][$data['personnel_id_5']])){
            echo $personnel_list['data'][$data['personnel_id_5']]['title']; 
            echo $personnel_list['data'][$data['personnel_id_5']]['name_th'].'&nbsp;'; 
            echo $personnel_list['data'][$data['personnel_id_5']]['surname_th'];
          }
      ...
      <span style="top: 70%;left: 62.5%;"><?php echo isset($data['position_personnel_5']) && trim($data['position_personnel_5'])!=''?$data['position_personnel_5']:''; ?></span>
      <span style="top: 72.2%;left: 63.5%;"><?php echo isset($data['signature_date_personnel_5']) && trim($data['signature_date_personnel_5'])!=''?date('d/m/',strtotime($data['signature_date_personnel_5'])).(date("Y",strtotime($data['signature_date_personnel_5']))+543):''; ?></span>

      <span style="top: 78%;left: 55.4%;"><?php echo isset($data['approve_personnel_6']) && intval($data['approve_personnel_6'])==1?'&#10003;':''; ?></span>
      <span style="top: 78%;left: 64.4%;"><?php echo isset($data['approve_personnel_6']) && intval($data['approve_personnel_6'])==2?'&#10003;':''; ?></span>
      <span style="top: 78%;left: 74.4%;"><?php echo isset($data['approve_personnel_6']) && intval($data['approve_personnel_6'])==3?'&#10003;':''; ?></span>
      ...
      <span style="top: 90.8%;left: 64%;"><?php echo isset($data['position_personnel_6']) && trim($data['position_personnel_6'])!=''?$data['position_personnel_6']:''; ?></span>
      <span style="top: 93%;left: 64%;"><?php echo isset($data['signature_date_personnel_6']) && trim($data['signature_date_personnel_6'])!=''?date('d/m/',strtotime($data['signature_date_personnel_6'])).(date("Y",strtotime($data['signature_date_personnel_6']))+543):''; ?></span>
    ...
    <?php }elseif(isset($data['leave_type_id']) && intval($data['leave_type_id'])==6){$doc[0] = 'document/leave/6.2.png';?>
      ...
      <span style="top: 46.8%;left: 28%;"><?php echo isset($data['period_count_all'])?floatval($data['period_count_all']):''; ?></span>
    ...
    <?php }elseif(isset($data['leave_type_id']) && intval($data['leave_type_id'])==9){$doc[0] = 'document/leave/9.2.png';?>
      ...
      <span style="top: 36.8%;left: 31.2%;"><?php echo date_th($data['period_end'],8);?></span>
      <span style="top: 36.8%;left: 44%;"><?php echo date_th($data['period_end'],10);?></span>
  ...
  <?php if(isset($data['status']) && intval($data['status'])==98){ ?>
    <div class="col-lg-12 document">
      ...
      <?php if(isset($data['approve_personnel_2']) && intval($data['approve_personnel_2'])==1){?>
        <span style="top: 57.5%;left: 15%;"><?php echo isset($data['approve_cancel_personnel_2']) && intval($data['approve_cancel_personnel_2'])==1?'&#10003;':''; ?></span>
        <span style="top: 57.5%;left: 32%;"><?php echo isset($data['approve_cancel_personnel_2']) && intval($data['approve_cancel_personnel_2'])==2?'&#10003;':''; ?></span>
        ...
        <span style="top: 66.2%;left: 22.5%;"><?php echo isset($data['position_personnel_2']) && trim($data['position_personnel_2'])!=''?$data['position_personnel_2']:''; ?></span>
        <span style="top: 68.5%;left: 23.5%;"><?php echo isset($data['signature_cancel_date_2']) && trim($data['signature_cancel_date_2'])!=''?date('d/m/',strtotime($data['signature_cancel_date_2'])).(date("Y",strtotime($data['signature_cancel_date_2']))+543):''; ?></span>
      <?php } ?>

      <?php if(isset($data['approve_personnel_3']) && intval($data['approve_personnel_3'])==1){?>
        <span style="top: 57.5%;left: 55%;"><?php echo isset($data['approve_cancel_personnel_3']) && intval($data['approve_cancel_personnel_3'])==1?'&#10003;':''; ?></span>
        <span style="top: 57.5%;left: 72%;"><?php echo isset($data['approve_cancel_personnel_3']) && intval($data['approve_cancel_personnel_3'])==2?'&#10003;':''; ?></span>
        <span style="top: 60.8%;left: 55%;"><img src="<?php echo isset($data['personnel_id_3']) && intval($data['personnel_id_3'])!=0 && $data['signature_cancel_date_3']!='' && isset($personnel_list['data'][$data['personnel_id_3']])?$personnel_list['data'][$data['personnel_id_3']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
        ...
        <span style="top: 66%;left: 63%;"><?php echo isset($data['position_personnel_3']) && trim($data['position_personnel_3'])!=''?$data['position_personnel_3']:''; ?></span>
        <span style="top: 68.5%;left: 63%;"><?php echo isset($data['signature_cancel_date_3']) && trim($data['signature_cancel_date_3'])!=''?date('d/m/',strtotime($data['signature_cancel_date_3'])).(date("Y",strtotime($data['signature_cancel_date_3']))+543):''; ?></span>
      <?php } ?>

      <?php if(isset($data['approve_personnel_4']) && intval($data['approve_personnel_4'])==1){?>
        <span style="top: 75.2%;left: 15%;"><?php echo isset($data['approve_cancel_personnel_4']) && intval($data['approve_cancel_personnel_4'])==1?'&#10003;':''; ?></span>
        <span style="top: 75.2%;left: 32%;"><?php echo isset($data['approve_cancel_personnel_4']) && intval($data['approve_cancel_personnel_4'])==2?'&#10003;':''; ?></span>
        <span style="top: 79.5%;left: 15.5%;"><img src="<?php echo isset($data['personnel_id_4']) && intval($data['personnel_id_4'])!=0 && $data['signature_cancel_date_4']!='' && isset($personnel_list['data'][$data['personnel_id_4']])?$personnel_list['data'][$data['personnel_id_4']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
        ...
        <span style="top: 84.5%;left: 22.5%;"><?php echo isset($data['position_personnel_4']) && trim($data['position_personnel_4'])!=''?$data['position_personnel_4']:''; ?></span>
        <span style="top: 87.2%;left: 23.5%;"><?php echo isset($data['signature_cancel_date_4']) && trim($data['signature_cancel_date_4'])!=''?date('d/m/',strtotime($data['signature_cancel_date_4'])).(date("Y",strtotime($data['signature_cancel_date_4']))+543):''; ?></span>
      <?php } ?>

      <?php if(isset($data['approve_personnel_5']) && intval($data['approve_personnel_5'])==1){?>
        <span style="top: 75.2%;left: 55.5%;"><?php echo isset($data['approve_cancel_personnel_5']) && intval($data['approve_cancel_personnel_5'])==1?'&#10003;':''; ?></span>
        <span style="top: 75.2%;left: 66%;"><?php echo isset($data['approve_cancel_personnel_5']) && intval($data['approve_cancel_personnel_5'])==2?'&#10003;':''; ?></span>
        <span style="top: 79.5%;left: 55%;"><img src="<?php echo isset($data['personnel_id_5']) && intval($data['personnel_id_5'])!=0 && $data['signature_cancel_date_5']!='' && isset($personnel_list['data'][$data['personnel_id_5']])?$personnel_list['data'][$data['personnel_id_5']]['signature']:base_url(load_file('assets/img/emp.png'));?>" class="img-sig"/></span>
        ...
        <span style="top: 84.5%;left: 63%;"><?php echo isset($data['position_personnel_5']) && trim($data['position_personnel_5'])!=''?$data['position_personnel_5']:''; ?></span>
        <span style="top: 87.2%;left: 64%;"><?php echo isset($data['signature_cancel_date_5']) && trim($data['signature_cancel_date_5'])!=''?date('d/m/',strtotime($data['signature_cancel_date_5'])).(date("Y",strtotime($data['signature_cancel_date_5']))+543):''; ?></span>
      <?php } ?>
