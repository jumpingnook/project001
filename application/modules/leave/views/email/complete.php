<?php //echo '<pre>';print_r($personnel); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div style="width:800px;height:100vh;background-color:#ffffff;margin:auto;position: relative;">
        ...
        <div>
            <p style="font-size:18px;">
                เรียน  ผู้บังคับบัญชา<br/><br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เนื่องจาก <?php echo $personnel['title'].$personnel['name_th'].' '.$personnel['surname_th'];?> ตำแหน่ง <?php echo $personnel['position_name'];?> มีความประสงค์ <u><?php echo $leave_type[$leave_data['leave_type_id']]['leave_name'];?></u> ตั้งแต่วันที่ <u><?php echo date_th($leave_data['period_start'],11).(trim($leave_data['period_end'])!=''?' - '.date_th($leave_data['period_end'],11):''); ?></u> ได้ผ่านการพิจารณาเรียบร้อยแล้ว
            </p>
        </div><br/><br/>
        <div>
