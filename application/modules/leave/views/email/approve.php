...
<body style="padding:0px;margin:0px;background-color:#ffffff;">
    <div style="width:800px;height:100vh;background-color:#ffffff;margin:auto;position: relative;">
        ...
        <div>
            <center><a href="<?php echo $leave_data['url_personnel_'.$url_type];?>"><button style="padding: 10px;border-radius: 5px;background-color: #4CAF50;color: #ffffff;font-size: 24px;">คลิกที่นี่ เพื่อดูรายละเอียดการลา</button></a></center>
        </div>
